...
sfpdRDD = sc.textFile("/headless/Desktop/next-level-python-big-data/spark-dev3600/data/sfpd.csv").map(lambda line: line.split(","))
...
catAdd = sc.textFile("/headless/Desktop/next-level-python-big-data/spark-dev3600/data/J_AddCat.csv").map(lambda x: x.split(",")).map(lambda x: (x[1], x[0]))
distAdd = sc.textFile("/headless/Desktop/next-level-python-big-data/spark-dev3600/data/J_AddDist.csv").map(lambda x: x.split(",")).map(lambda x: (x[1], x[0]))
